...
# CV voltage output
low_volt = 0  # output voltage value for lowest note
interval_volt = 0.083333  # output voltage interval between notes (1v/octave)

low_out = int((low_volt / 5) * 4096)
interval_out = int((interval_volt / 5) * 4096)
